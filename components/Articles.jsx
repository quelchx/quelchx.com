...
export default function Articles({ posts }) {
  const listData = posts.map((post) => {
    return (
      <AOS key={post.id} animation="fade-down" delay="200" duration="400">
        <Article
          title={post.title}
  ...
  return (
    <section className="relative py-16 dark:bg-gray-700 bg-gray-100 min-w-screen animation-fade animation-delay">
