    ...
    <blockquote className="flex items-center justify-between w-full col-span-1 p-6 dark:bg-gray-700 bg-white rounded-lg shadow">
      <div className="flex flex-col pr-8">
        <div className="relative pl-12">
          ...
          <p className="mt-2 text-sm dark:text-green-400 text-gray-600 sm:text-base lg:text-sm xl:text-base">
            {details}
          </p>
        </div>
        <p className="pl-12 mt-3 text-sm font-medium leading-5 dark:text-white text-gray-800 truncate sm:text-base lg:text-base">
          <span className="mx-2 text-sm leading-5 text-gray-500 dark:text-gray-200 truncate">
