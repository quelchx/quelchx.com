...
export default function ComputersSVG() {
  return (
    <svg
      className="pl-4 pt-10 sm:pr-10 xl:pl-10 lg:pr-32"
    ...
    >
      <defs>
        <linearGradient
          id="dff037aa-d578-4bab-81e7-399360663117-189"
          x1="597.75"
          y1="725.44"
          x2="597.75"
          y2="347.69"
      ...
      <rect
        ...
        fill="#65617d"
      />
      <rect x="394.26" y="108.49" width="186" height="144.33" fill="#065f46" />
      <polygon
      ...
      <path
        ...
        transform="translate(-79.34 -172.91)"
        fill="url(#dff037aa-d578-4bab-81e7-399360663117-189)"
      />
      <path
