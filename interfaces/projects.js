...
export const projects = [
  {
    name: "AOS Vue",
    details: "Animate on scroll single file component for Vue 3",
    path: "/",
    image:
  ...
  {
    name: "Vue Typewriter",
    details: "Typewriting component with lots of features built for Vue 3",
    path: "/",
    image: "https://avatars.githubusercontent.com/u/6128107?s=280&v=4",
  },
  {
    name: "Perty UI",
    details: "Github inspired dark theme with a twist for Visual Studio Code",
    path: "/",
    image:
